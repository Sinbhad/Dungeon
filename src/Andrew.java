public class Andrew extends Enemy{
    public Andrew(){
        ...
        setMoves(new Move("Pledge Ritual", this.getName() + " made you embarrass yourself in front of the whole school \nPledge Ritual dealt 20 emotional damage", 20));
        setMoves(new Move("Dog Ears",this.getName() + " put on his dog ears, you were tricked into thinking he was really a dog. \n When you tried to pet him he slapped you dealing 50 damage", 50));
        setMoves(new Move("Deepseek", this.getName() + " made you think of every embarrassing thing you have ever done, the mental trauma caused you to take 15 damage", 15));
    }
}
